...
def load_data(test_size= 0.2, sr = 16000, n_fft = 2048, hop_length = 512, n_mfcc = 13):
    data_directory_path = 'Data/Audio/WAV_16000/Segmented'

    labels = pd.read_csv('labels.csv')
    
    labels['segment_name'] = labels['video_name']+'_'+labels['segment_number'].astype(str)+'.wav'
    
    labels.sort_values(['segment_name'], inplace= True)
    ...
    x_train, x_test, y_train, y_test = train_test_split(data, targets, random_state= 10,
